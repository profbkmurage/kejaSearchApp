...
function renderBlogs(blogs) {
  ...
  <div class="product-item bg-light mb-4">
    <div class="product-img position-relative overflow-hidden">
      <img class="img-fluid w-100" style="height:30vh;" src="${blog.downloadURL}" />
    </div>
    <div class="text-left py-4 bg-primary">
      <h6 class="text-decoration-none text-truncate text-light px-3">${blog.category} <br> Location: ${blog.location} </h6>
      <h6><a class="text-light px-3" href="tel:${blog.number}">Contact: ${blog.number}</a></h6>
    </div>
    <hr>
    <p class="text-dark text-left">${blog.description}</p>
